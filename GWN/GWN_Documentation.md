...
- **CH Recruitment**: Accept CH_REQ, send local key, track CH children
- **CH_INFO Relay**: Forward CH recruitment announcements to Sink
...
- **CH Discovery DVS**: Boost HC12 power if no new CH recruits detected
